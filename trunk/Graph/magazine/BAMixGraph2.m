...
@implementation BAMixGraph2
{
    CPTPlotSpaceAnnotation *symbolTextAnnotation;
    bool isLongPress;
    CPTPlot *selectedPlot;
    CPTFill *originalBarFill;
    ...
    for (int i=0; i<report.reportData.metrics.count; i++) {
        ...
        switch (metric.plotType) {
            case 0:
            {
                ...
                CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"032c48" alpha:@"1"] endingColor:[BAColorHelper stringToCPTColor:@"197aa5" alpha:@"1"]];
                gradient.angle=90;
                barPlot.fill=[CPTFill fillWithGradient:gradient];
                originalBarFill=[CPTFill fillWithGradient:gradient];
            ...
            case 1:
            {
                ...
                lineStyle.lineColor=[BAColorHelper stringToCPTColor:@"08e0ed" alpha:@"1"];
            ...
            case 2:
            {
                ...
                lineStyle.lineWidth=2;
                linePlot.dataLineStyle=lineStyle;  
                CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[CPTColor clearColor] endingColor:[BAColorHelper stringToCPTColor:@"197aa5" alpha:@"0.6"]];
                //CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"092862" alpha:@"0.8"] endingColor:[CPTColor clearColor] beginningPosition:0.3 endingPosition:1];
                gradient.angle=90;
...
-(void)renderAxisInHostView:(CPTGraphHostingView *)hostView
{
    ...
    axisStyle.lineColor=[BAColorHelper stringToCPTColor:@"033e5e" alpha:@"1"];
    ...
    yMajorGridLineStyle.lineWidth=0.5;
    yMajorGridLineStyle.lineColor=[BAColorHelper stringToCPTColor:@"033e5e" alpha:@"1"];
...
//    float y2width = [yString2 sizeWithFont:[UIFont boldSystemFontOfSize:15]].width;
    ...
    graph.plotAreaFrame.paddingLeft=60+10;
...
-(CPTPlotSymbol *)symbolForScatterPlot:(CPTScatterPlot *)plot recordIndex:(NSUInteger)index
{
    ...
    symbol.size=CGSizeMake(13,13);
    plot.plotSymbol=symbol;
    if (index==selectedIndex) {
        if (selectedIndex==0) {
            symbol.fill=[CPTFill fillWithColor:[BAColorHelper stringToCPTColor:@"08e0ed" alpha:@"1"]];
            return symbol;
        }else
        {
            if (isPositive) {
                symbolLineStyle.lineColor=[CPTColor whiteColor];
                symbol.fill=[CPTFill fillWithColor:[BAColorHelper stringToCPTColor:@"00ff00" alpha:@"1"]];
            }else
            {
                symbolLineStyle.lineColor=[CPTColor whiteColor];
                symbol.fill=[CPTFill fillWithColor:[BAColorHelper stringToCPTColor:@"f30035" alpha:@"1"]];
            }
            return symbol;
        }
        
    }else if(index==selectedIndex-1&&selectedIndex>0){
        symbol.size=CGSizeMake(10,10);
        symbol.fill=[CPTFill fillWithColor:[BAColorHelper stringToCPTColor:@"08e0ed" alpha:@"1"]];
        return symbol;
    }else
...
{
    if (index==selectedIndex) {
        //CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"fe6611" alpha:@"1"] endingColor:[BAColorHelper stringToCPTColor:@"ffb500" alpha:@"1"]];
        //CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"f30035" alpha:@"1"] endingColor:[BAColorHelper stringToCPTColor:@"9a002c" alpha:@"1"]];
        if (isPositive) {
            CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"536f1d" alpha:@"1"] endingColor:[BAColorHelper stringToCPTColor:@"a9d447" alpha:@"1"]];
            gradient.angle=90;
            return [CPTFill fillWithGradient:gradient];
        }else
        {
            CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"9a002c" alpha:@"1"] endingColor:[BAColorHelper stringToCPTColor:@"f30035" alpha:@"1"]];
            gradient.angle=90;
            return [CPTFill fillWithGradient:gradient];
        }
