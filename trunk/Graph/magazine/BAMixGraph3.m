    ...
    for (int i=0; i<report.reportData.metrics.count; i++) {
        ...
        switch (metric.plotType) {
            ...
            case 2:
            {
                linePlot.identifier=metric.metricName;
                CPTMutableLineStyle *lineStyle=[CPTMutableLineStyle lineStyle];
                lineStyle.lineColor=[BAColorHelper stringToCPTColor:@"08e2ec" alpha:@"1"];
                lineStyle.lineWidth=1.5;
                linePlot.dataLineStyle=lineStyle;  
                //CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"092862" alpha:@"0.8"] endingColor:[CPTColor clearColor]];
                CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"1879a4" alpha:@"0.8"] endingColor:[CPTColor clearColor] beginningPosition:0.3 endingPosition:1];
                gradient.angle=-90;
                ...
                linePlot.areaBaseValue=[[NSDecimalNumber numberWithFloat:0]decimalValue];
...
//    NSDecimal newLength=[[a decimalNumberByAdding:b] decimalValue];
    ...
    axisStyle.lineColor=[BAColorHelper stringToCPTColor:@"1879a4" alpha:@"1"];
...
//    }
    ...
    yMajorGridLineStyle.lineColor=[BAColorHelper stringToCPTColor:@"1879a4" alpha:@"1"];
...
//    float y2width = [yString2 sizeWithFont:[UIFont boldSystemFontOfSize:15]].width;
    ...
    graph.plotAreaFrame.paddingLeft=80;
