...
-(UIImage*)microImage
{
    ...
    CPTGradient *gradient=[CPTGradient gradientWithBeginningColor:[BAColorHelper stringToCPTColor:@"454545" alpha:@"1"] endingColor:[CPTColor clearColor] ];
    gradient.angle=90;
