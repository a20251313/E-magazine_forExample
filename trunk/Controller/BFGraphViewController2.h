...
@interface BFGraphViewController2 : UIViewController<UITableViewDataSource,UITableViewDelegate,BATouchViewDelegate>
{
    float tempX;
    float tempX2;
}
...
@property (strong,nonatomic) IBOutlet CPTGraphHostingView *hostSlider;
...
@property (strong, nonatomic) UIImageView *floatingView;
@end
