...
@implementation NewDataFactory

+ (bookData *)createBook1{
    bookData *data = [[bookData alloc] init];
    data.bookName = @"2012年度报告";
    data.covorImage = @"Book02.png";
    
    NSMutableArray *arrChapterData = [[NSMutableArray alloc] init];
#pragma mark chapter1
    chapterData *chapter = [[chapterData alloc] init];
    chapter.chapterName =  @"2012年年度报告";
    NSMutableArray *arrTextData = [[NSMutableArray alloc] init];
    textData *text = [self createTextData0];
    [arrTextData addObject:text];
    [text release];
    
    chapter.textData = arrTextData;
    [arrChapterData addObject:chapter];
    [chapter release];
    
#pragma mark chapter2
    chapterData *chapter1 = [[chapterData alloc] init];
    chapter1.chapterName =  @"2012年年度报告目录";
    NSMutableArray *arrTextData1 = [[NSMutableArray alloc] init];
    textData *text1 = [self createTextData1];
    [arrTextData1 addObject:text1];
    [text1 release];
    
    chapter1.textData = arrTextData1;
    [arrChapterData addObject:chapter1];
    [chapter1 release];
    
#pragma mark chapter3
    chapterData *chapter2 = [[chapterData alloc] init];
    chapter2.chapterName = @"年度要点";
    NSMutableArray *arrTextData2 = [[NSMutableArray alloc] init];
    
    textData *text2 = [self createTextData2];
    [arrTextData2 addObject:text2];
    [text2 release];
    
    textData *text2_1 = [self createTextData2_1];
    [arrTextData2 addObject:text2_1];
    [text2_1 release];
    
    textData *text2_2 = [self createTextData2_2];
    [arrTextData2 addObject:text2_2];
    [text2_2 release];
    
    chapter2.textData = arrTextData2;
    [arrChapterData addObject:chapter2];
    [chapter2 release];
    
#pragma mark chapter4
    chapterData *chapter3 = [[chapterData alloc] init];
    chapter3.chapterName = @"分析报告";
    NSMutableArray *arrTextData3 = [[NSMutableArray alloc] init];
    
    textData *text3 = [self createTextData3];
    [arrTextData3 addObject:text3];
    [text2 release];
    
    textData *text3_1 = [self createTextData3_1];
    [arrTextData3 addObject:text3_1];
    [text3_1 release];
    
    chapter3.textData = arrTextData3;
    [arrChapterData addObject:chapter3];
    [chapter3 release];
#pragma mark chapter5
    chapterData *chapter4 = [[chapterData alloc] init];
    chapter4.chapterName = @"经营风险分析";
    NSMutableArray *arrTextData4 = [[NSMutableArray alloc] init];
    
    textData *text4 = [self createTextData4];
    [arrTextData4 addObject:text4];
    [text4 release];
    
    textData *text4_1 = [self createTextData4_1];
    [arrTextData4 addObject:text4_1];
    [text4_1 release];
    
    textData *text4_2 = [self createTextData4_2];
    [arrTextData4 addObject:text4_2];
    [text4_2 release];
    
    chapter4.textData = arrTextData4;
    [arrChapterData addObject:chapter4];
    [chapter4 release];
#pragma mark chapter6
    chapterData *chapter5 = [[chapterData alloc] init];
    chapter5.chapterName = @"环境与展望";
    NSMutableArray *arrTextData5 = [[NSMutableArray alloc] init];
    
    textData *text5 = [self createTextData5];
    [arrTextData5 addObject:text5];
    [text5 release];
    
    textData *text5_1 = [self createTextData5_1];
    [arrTextData5 addObject:text5_1];
    [text5_1 release];
    
    chapter5.textData = arrTextData5;
    [arrChapterData addObject:chapter5];
    [chapter5 release];
#pragma mark chapter7
    chapterData *chapter6 = [[chapterData alloc] init];
    chapter6.chapterName = @"业务前景";
    NSMutableArray *arrTextData6 = [[NSMutableArray alloc] init];
    
    textData *text6 = [self createTextData6];
    [arrTextData6 addObject:text6];
    [text6 release];
    
    textData *text6_1 = [self createTextData6_1];
    [arrTextData6 addObject:text6_1];
    [text6_1 release];
    
    chapter6.textData = arrTextData6;
    [arrChapterData addObject:chapter6];
    [chapter6 release];
#pragma mark chapter8
    chapterData *chapter7 = [[chapterData alloc] init];
    chapter7.chapterName = @"三年规划";
    NSMutableArray *arrTextData7 = [[NSMutableArray alloc] init];
    
    textData *text7 = [self createTextData7];
    [arrTextData7 addObject:text7];
    [text7 release];
    
    textData *text7_1 = [self createTextData7_1];
    [arrTextData7 addObject:text7_1];
    [text7_1 release];
    
    chapter7.textData = arrTextData7;
    [arrChapterData addObject:chapter7];
    [chapter7 release];
#pragma mark chapter9
    chapterData *chapter8 = [[chapterData alloc] init];
    chapter8.chapterName = @"图表索引";
    NSMutableArray *arrTextData8 = [[NSMutableArray alloc] init];
    
    textData *text8 = [self createTextData8];
    [arrTextData8 addObject:text8];
    [text8 release];
    
    chapter8.textData = arrTextData8;
    [arrChapterData addObject:chapter8];
    [chapter8 release];
#pragma mark chapter10
    chapterData *chapter9 = [[chapterData alloc] init];
    chapter9.chapterName = @"结论索引";
    NSMutableArray *arrTextData9 = [[NSMutableArray alloc] init];
    
    textData *text9 = [self createTextData9];
    [arrTextData9 addObject:text9];
    [text9 release];
    
    chapter9.textData = arrTextData9;
    [arrChapterData addObject:chapter9];
    [chapter9 release];
    
    data.chapterData = arrChapterData;
    [chapterData release];
...
+ (textData *)createTextData0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter1_1.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter1_1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
    
    NSMutableArray *arrPicNames = [[NSMutableArray alloc] initWithObjects:pName, nil];
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] initWithObjects:pNamePor, nil];
    NSMutableArray *arrPicRects = [[NSMutableArray alloc] initWithObjects:picRect, nil];
    NSMutableArray *arrPicRectsPor = [[NSMutableArray alloc] initWithObjects:picRectPor, nil];
    
    text.picNames = arrPicNames;
    text.picNamesPor = arrPicNamesPor;
    text.picRects = arrPicRects;
    text.picRectsPor = arrPicRectsPor;
    
    [arrPicNames release];
    [pName release];
    [arrPicNamesPor release];
    [pNamePor release];
    [arrPicRects release];
    [picRect release];
    [arrPicRectsPor release];
    [picRectPor release];
...
+ (textData *)createTextData1{
    ...
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter3_1.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter3_1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2{
    ...
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter4_1.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter4_1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2_1{
    ...
    text.titleFontSize = @"38";
    text.titleLength = @"6";
    text.titleFontName = @"Helvetica";
    text.contentFontSize = @"14";
    text.contentFontName = @"Helvetica";
    
    //指定字体颜色和区域
    NSMutableArray *arrColors = [[NSMutableArray alloc] init];
    colors *col = [[colors alloc] init];
    col.color = @"redColor";
    [arrColors addObject:col];
    [col release];
    
    NSMutableArray *arrColorsPor = [[NSMutableArray alloc] init];
    colorsPor *colPor = [[colorsPor alloc] init];
    colPor.colorPor = @"redColor";
    [arrColorsPor addObject:colPor];
    [colPor release];
    
    NSMutableArray *arrRanges = [[NSMutableArray alloc] init];
    ranges *ran = [[ranges alloc] init];
    ran.range = NSStringFromRange(NSMakeRange(0,7));
    [arrRanges addObject:ran];
    [ran release];
    
    NSMutableArray *arrRangesPor = [[NSMutableArray alloc] init];
    rangesPor *ranPor = [[rangesPor alloc] init];
    ranPor.rangePor = NSStringFromRange(NSMakeRange(0,7));
    [arrRangesPor addObject:ranPor];
    [ranPor release];
    
    text.colors = arrColors;
    [arrColors release];
    text.ranges = arrRanges;
    [arrRanges release];
    text.colorsPor = arrColorsPor;
    [arrColorsPor release];
    text.rangesPor = arrRangesPor;
    [arrRangesPor release];
    
    //landscape
    //图片位置
    text.rects = [NewLessTextNoAbstract setTextRect];
    text.picRects = [NewLessTextNoAbstract setImageRect];
    //portrait
    text.rectsPor = [NewLessTextNoAbstractPor setTextRect];
    text.picRectsPor = [NewLessTextNoAbstractPor setImageRect];
    
    //图片名称
    NSMutableArray *arrPicNames = [[NSMutableArray alloc] init];
    picNames *picName = [[picNames alloc] init];
    picName.picName = @"B2C1A1.png";
    [arrPicNames addObject:picName];
    [picName release];
    text.picNames = arrPicNames;
    
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B2C1A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    [picNamePor release];
    text.picNamesPor = arrPicNamesPor;
    
    //push Class
    NSMutableArray *arrPushClassNames = [[NSMutableArray alloc] init];
    pushClassNames *pushClassName = [[pushClassNames alloc ]init];
    pushClassName.pushClassName = @"BFGraphViewController2";
    [arrPushClassNames addObject:pushClassName];
    [pushClassName release];
    text.pushClassNames = arrPushClassNames;
    
    return text;
}
+ (textData *)createTextData2_2{
    textData *text = [[textData alloc] init];
    ...
    //landscape
    //图片位置
    text.rects = [NewMoreTextNoAbstract setTextRect];
    text.picRects = [NewMoreTextNoAbstract setImageRect];
    //portrait
    text.rectsPor = [NewLessTextNoAbstractPor setTextRect];
    text.picRectsPor = [NewLessTextNoAbstractPor setImageRect];
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B2C1A2Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
    ...
    NSMutableArray *arrPushClassNames = [[NSMutableArray alloc] init];
    pushClassNames *pushClassName = [[pushClassNames alloc ]init];
    pushClassName.pushClassName = @"BFGraphViewController4";
    [arrPushClassNames addObject:pushClassName];
    [pushClassName release];
    text.pushClassNames = arrPushClassNames;
...
+ (textData *)createTextData3{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter5_1.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter5_1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData3_1{
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B2C2A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData3_2{
    ...
    NSMutableArray *arrRanges = [[NSMutableArray alloc] init];
    ranges *ran = [[ranges alloc] init];
    ran.range = NSStringFromRange(NSMakeRange(0,5));
    [arrRanges addObject:ran];
    [ran release];
    
    NSMutableArray *arrRangesPor = [[NSMutableArray alloc] init];
    rangesPor *ranPor = [[rangesPor alloc] init];
    ranPor.rangePor = NSStringFromRange(NSMakeRange(0,5));
    [arrRangesPor addObject:ranPor];
    [ranPor release];
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B2C2A2Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData4_1{
    ...
    text.picRects = [NewMoreTextNoAbstract setImageRect];
    //portrait
    text.rectsPor = [NewMoreTextNoAbstractPor setTextRect];
    text.picRectsPor = [NewMoreTextNoAbstractPor setImageRect];
    
    //图片名称
    NSMutableArray *arrPicNames = [[NSMutableArray alloc] init];
    picNames *picName = [[picNames alloc] init];
    picName.picName = @"B2C3A1.png";
    [arrPicNames addObject:picName];
    [picName release];
    text.picNames = arrPicNames;
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B2C3A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData5{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter6_1.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter6_1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData5_1{
    ...
    NSMutableArray *arrRanges = [[NSMutableArray alloc] init];
    ranges *ran = [[ranges alloc] init];
    ran.range = NSStringFromRange(NSMakeRange(0,6));
    [arrRanges addObject:ran];
    [ran release];
    
    NSMutableArray *arrRangesPor = [[NSMutableArray alloc] init];
    rangesPor *ranPor = [[rangesPor alloc] init];
    ranPor.rangePor = NSStringFromRange(NSMakeRange(0,6));
    [arrRangesPor addObject:ranPor];
    [ranPor release];
    ...
    NSMutableArray *arrPicNames = [[NSMutableArray alloc] init];
    picNames *picName = [[picNames alloc] init];
    picName.picName = @"shortTextPic.png";
    [arrPicNames addObject:picName];
    [picName release];
    text.picNames = arrPicNames;
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"textPicPor.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
    ...
    NSMutableArray *arrPushClassNames = [[NSMutableArray alloc] init];
    pushClassNames *pushClassName = [[pushClassNames alloc ]init];
    pushClassName.pushClassName = @"BFGraphViewController1";
    [arrPushClassNames addObject:pushClassName];
    [pushClassName release];
    text.pushClassNames = arrPushClassNames;
...
+ (textData *)createTextData6_1{
    ...
    NSMutableArray *arrRanges = [[NSMutableArray alloc] init];
    ranges *ran = [[ranges alloc] init];
    ran.range = NSStringFromRange(NSMakeRange(0,19));
    [arrRanges addObject:ran];
    [ran release];
    
    NSMutableArray *arrRangesPor = [[NSMutableArray alloc] init];
    rangesPor *ranPor = [[rangesPor alloc] init];
    ranPor.rangePor = NSStringFromRange(NSMakeRange(0,19));
    [arrRangesPor addObject:ranPor];
    [ranPor release];
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B2C5A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData8{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter7_1.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter7_1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData9{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter8_1.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter8_1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (bookData *)createBook2{
    bookData *data = [[bookData alloc] init];
    data.bookName = @"消费信贷市场";
    data.covorImage = @"Book03.png";
    
    NSMutableArray *arrChapterData = [[NSMutableArray alloc] init];
#pragma mark chapter1
    chapterData *chapter = [[chapterData alloc] init];
    chapter.chapterName =  @"中国消费信贷市场解析";
    NSMutableArray *arrTextData = [[NSMutableArray alloc] init];
    textData *text = [self createTextData1_0];
    [arrTextData addObject:text];
    [text release];
...
#pragma mark chapter2
    chapterData *chapter1 = [[chapterData alloc] init];
    chapter1.chapterName =  @"中国消费信贷市场解析目录";
    NSMutableArray *arrTextData1 = [[NSMutableArray alloc] init];
    textData *text1 = [self createTextData1_1];
    [arrTextData1 addObject:text1];
    [text1 release];
...
#pragma mark chapter3
    chapterData *chapter2 = [[chapterData alloc] init];
    chapter2.chapterName = @"我行个人信贷业务重点";
    NSMutableArray *arrTextData2 = [[NSMutableArray alloc] init];
    
    textData *text2 = [self createTextData1_2];
    [arrTextData2 addObject:text2];
    [text2 release];
    
    textData *text2_1 = [self createTextData1_2_1];
    [arrTextData2 addObject:text2_1];
    [text2_1 release];
    
    textData *text2_2 = [self createTextData1_2_2];
    [arrTextData2 addObject:text2_2];
    [text2_2 release];
...
#pragma mark chapter4
    chapterData *chapter3 = [[chapterData alloc] init];
    chapter3.chapterName = @"要点分析";
    NSMutableArray *arrTextData3 = [[NSMutableArray alloc] init];
    
    textData *text3 = [self createTextData1_3];
    [arrTextData3 addObject:text3];
    [text2 release];
    
    textData *text3_1 = [self createTextData1_3_1];
    [arrTextData3 addObject:text3_1];
    [text3_1 release];
...
#pragma mark chapter5
    chapterData *chapter4 = [[chapterData alloc] init];
    chapter4.chapterName = @"新生市场：即将迎来爆发式增长";
    NSMutableArray *arrTextData4 = [[NSMutableArray alloc] init];
    
    textData *text4 = [self createTextData1_4];
    [arrTextData4 addObject:text4];
    [text4 release];
    
    textData *text4_1 = [self createTextData1_4_1];
    [arrTextData4 addObject:text4_1];
    [text4_1 release];
    
    textData *text4_2 = [self createTextData1_4_2];
    [arrTextData4 addObject:text4_2];
    [text4_2 release];
...
#pragma mark chapter6
    chapterData *chapter5 = [[chapterData alloc] init];
    chapter5.chapterName = @"借贷方的下一步行动";
    NSMutableArray *arrTextData5 = [[NSMutableArray alloc] init];
    
    textData *text5 = [self createTextData1_5];
    [arrTextData5 addObject:text5];
    [text5 release];
    
    textData *text5_1 = [self createTextData1_5_1];
    [arrTextData5 addObject:text5_1];
    [text5_1 release];
...
#pragma mark chapter7
    chapterData *chapter6 = [[chapterData alloc] init];
    chapter6.chapterName = @"业务规划";
    NSMutableArray *arrTextData6 = [[NSMutableArray alloc] init];
    
    textData *text6 = [self createTextData1_6];
    [arrTextData6 addObject:text6];
    [text6 release];
    
    textData *text6_1 = [self createTextData1_6_1];
    [arrTextData6 addObject:text6_1];
    [text6_1 release];
...
#pragma mark chapter8
    chapterData *chapter7 = [[chapterData alloc] init];
    chapter7.chapterName = @"图表索引";
    NSMutableArray *arrTextData7 = [[NSMutableArray alloc] init];
    
    textData *text7 = [self createTextData1_7];
    [arrTextData7 addObject:text7];
    [text7 release];
...
#pragma mark chapter9
    chapterData *chapter8 = [[chapterData alloc] init];
    chapter8.chapterName = @"结论索引";
    NSMutableArray *arrTextData8 = [[NSMutableArray alloc] init];
    
    textData *text8 = [self createTextData1_8];
    [arrTextData8 addObject:text8];
    [text8 release];
...
+ (textData *)createTextData1_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter1_2.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter1_2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData1_1{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter3_2.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter3_2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData1_2{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter5_2.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter5_2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData1_2_1{
    ...
    NSMutableArray *arrRanges = [[NSMutableArray alloc] init];
    ranges *ran = [[ranges alloc] init];
    ran.range = NSStringFromRange(NSMakeRange(0,11));
    [arrRanges addObject:ran];
    [ran release];
    
    NSMutableArray *arrRangesPor = [[NSMutableArray alloc] init];
    rangesPor *ranPor = [[rangesPor alloc] init];
    ranPor.rangePor = NSStringFromRange(NSMakeRange(0,11));
    [arrRangesPor addObject:ranPor];
    [ranPor release];
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B3C1A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData1_2_2{
    ...
    NSMutableArray *arrRanges = [[NSMutableArray alloc] init];
    ranges *ran = [[ranges alloc] init];
    ran.range = NSStringFromRange(NSMakeRange(0,9));
    [arrRanges addObject:ran];
    [ran release];
    
    NSMutableArray *arrRangesPor = [[NSMutableArray alloc] init];
    rangesPor *ranPor = [[rangesPor alloc] init];
    ranPor.rangePor = NSStringFromRange(NSMakeRange(0,9));
    [arrRangesPor addObject:ranPor];
    [ranPor release];
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B3C1A2Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData1_3{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter4_2.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter4_2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData1_3_1{
    ...
    NSMutableArray *arrRanges = [[NSMutableArray alloc] init];
    ranges *ran = [[ranges alloc] init];
    ran.range = NSStringFromRange(NSMakeRange(0,14));
    [arrRanges addObject:ran];
    [ran release];
    
    NSMutableArray *arrRangesPor = [[NSMutableArray alloc] init];
    rangesPor *ranPor = [[rangesPor alloc] init];
    ranPor.rangePor = NSStringFromRange(NSMakeRange(0,14));
    [arrRangesPor addObject:ranPor];
    [ranPor release];
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B3C2A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData1_4_1{
    textData *text = [[textData alloc] init];
    
    text.title = @"消费信贷为何在增长";
    ...
    colors *col_1 = [[colors alloc] init];
    col_1.color = @"whiteColor";
    [arrColors addObject:col_1];
    [col_1 release];
    ...
    colorsPor *colPor_1 = [[colorsPor alloc] init];
    colPor_1.colorPor = @"whiteColor";
    [arrColorsPor addObject:colPor_1];
    [colPor_1 release];
    ...
    ranges *ran_1 = [[ranges alloc] init];
    ran_1.range = NSStringFromRange(NSMakeRange(10,166));
    [arrRanges addObject:ran_1];
    [ran_1 release];
    ...
    rangesPor *ranPor_1 = [[rangesPor alloc] init];
    ranPor_1.rangePor = NSStringFromRange(NSMakeRange(10,152));
    [arrRangesPor addObject:ranPor_1];
    [ranPor_1 release];
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B3C3A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
    
    //BG图片名称
    NSMutableArray *arrBgNames = [[NSMutableArray alloc] init];
    bgNames *bgName = [[bgNames alloc] init];
    bgName.bgName = @"pic3.png";
    [arrBgNames addObject:bgName];
    [bgName release];
    text.bgNames = arrBgNames;
    
    NSMutableArray *arrBgNamesPor = [[NSMutableArray alloc] init];
    bgNamesPor *bgNamePor = [[bgNamesPor alloc] init];
    bgNamePor.bgNamePor = @"pic3Por.png";
    [arrPicNamesPor addObject:bgNamePor];
    [bgNamePor release];
    text.bgNamesPor = arrBgNamesPor;
    
    //BG图片位置
    NSMutableArray *arrBgRects = [[NSMutableArray alloc] init];
    bgRects *bgRect = [[bgRects alloc] init];
    bgRect.bgRect = NSStringFromCGRect(CGRectMake(0, 161, 907, 170));
    [arrBgRects addObject:bgRect];
    [bgRect release];
    text.bgRects = arrBgRects;
    
    NSMutableArray *arrBgRectsPor = [[NSMutableArray alloc] init];
    bgRectsPor *bgRectPor = [[bgRectsPor alloc] init];
    bgRectPor.bgRectPor = NSStringFromCGRect(CGRectMake(0, 177, 704, 170));
    [arrBgRectsPor addObject:bgRectPor];
    [bgRectPor release];
    text.bgRectsPor = arrBgRectsPor;
...
+ (textData *)createTextData1_4_2{
    ...
    NSMutableArray *arrRanges = [[NSMutableArray alloc] init];
    ranges *ran = [[ranges alloc] init];
    ran.range = NSStringFromRange(NSMakeRange(0,15));
    [arrRanges addObject:ran];
    [ran release];
    
    NSMutableArray *arrRangesPor = [[NSMutableArray alloc] init];
    rangesPor *ranPor = [[rangesPor alloc] init];
    ranPor.rangePor = NSStringFromRange(NSMakeRange(0,15));
    [arrRangesPor addObject:ranPor];
    [ranPor release];
    ...
    //landscape
    //图片位置
    text.rects = [NewLeastTextNoAbstract setTextRect];
    text.picRects = [NewLeastTextNoAbstract setImageRect];
    //portrait
    text.rectsPor = [NewLeastTextNoAbstractPor setTextRect];
    text.picRectsPor = [NewLeastTextNoAbstractPor setImageRect];
    
    //图片名称
    NSMutableArray *arrPicNames = [[NSMutableArray alloc] init];
    picNames *picName = [[picNames alloc] init];
    picName.picName = @"B3C3A2.png";
    [arrPicNames addObject:picName];
    [picName release];
    text.picNames = arrPicNames;
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B3C3A2Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData1_5{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter6_2.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter6_2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData1_5_1{
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B3C4A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData1_7{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter7_2.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter7_2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData1_8{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter8_2.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter8_2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (bookData *)createBook3{
    bookData *data = [[bookData alloc] init];
    data.bookName = @"投资分析周报";
    data.covorImage = @"Book04.png";
    
    NSMutableArray *arrChapterData = [[NSMutableArray alloc] init];
#pragma mark chapter1
    chapterData *chapter = [[chapterData alloc] init];
    chapter.chapterName =  @"银行业投资分析周报";
    NSMutableArray *arrTextData = [[NSMutableArray alloc] init];
    textData *text = [self createTextData2_0_0];
    [arrTextData addObject:text];
    [text release];
...
#pragma mark chapter2
    chapterData *chapter1 = [[chapterData alloc] init];
    chapter1.chapterName =  @"投资分析周报目录";
    NSMutableArray *arrTextData1 = [[NSMutableArray alloc] init];
    textData *text1 = [self createTextData2_1_0];
    [arrTextData1 addObject:text1];
    [text1 release];
...
#pragma mark chapter3
    chapterData *chapter2 = [[chapterData alloc] init];
    chapter2.chapterName = @"市场表现";
    NSMutableArray *arrTextData2 = [[NSMutableArray alloc] init];
    
    textData *text2 = [self createTextData2_2_0];
    [arrTextData2 addObject:text2];
    [text2 release];
    
    textData *text2_1 = [self createTextData2_2_1];
    [arrTextData2 addObject:text2_1];
    [text2_1 release];
...
#pragma mark chapter4
    chapterData *chapter3 = [[chapterData alloc] init];
    chapter3.chapterName = @"行业动态";
    NSMutableArray *arrTextData3 = [[NSMutableArray alloc] init];
    
    textData *text3 = [self createTextData2_3_0];
    [arrTextData3 addObject:text3];
    [text2 release];
    
    textData *text3_1 = [self createTextData2_3_1];
    [arrTextData3 addObject:text3_1];
    [text3_1 release];
    
    textData *text3_2 = [self createTextData2_3_2];
    [arrTextData3 addObject:text3_2];
    [text3_2 release];
    
    textData *text3_3 = [self createTextData2_3_3];
    [arrTextData3 addObject:text3_3];
    [text3_3 release];
...
#pragma mark chapter5
    chapterData *chapter4 = [[chapterData alloc] init];
    chapter4.chapterName = @"公司追踪";
    NSMutableArray *arrTextData4 = [[NSMutableArray alloc] init];
    
    textData *text4 = [self createTextData2_4_0];
    [arrTextData4 addObject:text4];
    [text4 release];
    
    textData *text4_1 = [self createTextData2_4_1];
    [arrTextData4 addObject:text4_1];
    [text4_1 release];
...
#pragma mark chapter6
    chapterData *chapter5 = [[chapterData alloc] init];
    chapter5.chapterName = @"本期个股推荐";
    NSMutableArray *arrTextData5 = [[NSMutableArray alloc] init];
    
    textData *text5 = [self createTextData2_5_0];
    [arrTextData5 addObject:text5];
    [text5 release];
    
    textData *text5_1 = [self createTextData2_5_1];
    [arrTextData5 addObject:text5_1];
    [text5_1 release];
...
#pragma mark chapter7
    chapterData *chapter6 = [[chapterData alloc] init];
    chapter6.chapterName = @"图表索引";
    NSMutableArray *arrTextData6 = [[NSMutableArray alloc] init];
    
    textData *text6 = [self createTextData2_6_0];
    [arrTextData6 addObject:text6];
    [text6 release];
...
#pragma mark chapter8
    chapterData *chapter7 = [[chapterData alloc] init];
    chapter7.chapterName = @"结论索引";
    NSMutableArray *arrTextData7 = [[NSMutableArray alloc] init];
    
    textData *text7 = [self createTextData2_7_0];
    [arrTextData7 addObject:text7];
    [text7 release];
...
+ (textData *)createTextData2_0_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"InvationChapter1Lan.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"InvationChapter1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2_1_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"InvationChapter2Lan.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"InvationChapter2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2_2_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"InvationChapter3Lan.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"InvationChapter3Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2_2_1{
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B4C1A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData2_3_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"InvationChapter4Lan.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"InvationChapter4Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2_3_1{
    ...
    key *aKey = [[key alloc] init];
    aKey.tag = @"1";
    aKey.range = NSStringFromRange(NSMakeRange(103, 4));
    [arrKey addObject:aKey];
    [aKey release];
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B4C2A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData2_3_2{
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B4C2A2Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData2_3_3{
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B4C2A3Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
    ...
    NSMutableArray *arrPushClassNames = [[NSMutableArray alloc] init];
    pushClassNames *pushClassName = [[pushClassNames alloc ]init];
    pushClassName.pushClassName = @"BFPieViewController";
    [arrPushClassNames addObject:pushClassName];
    [pushClassName release];
    text.pushClassNames = arrPushClassNames;
...
+ (textData *)createTextData2_4_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"InvationChapter5Lan.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"InvationChapter5Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2_4_1{
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B4C3A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData2_5_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"InvationChapter6Lan.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"InvationChapter6Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2_5_1{
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"B4C4A1Por.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData2_6_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"InvationChapter7Lan.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"InvationChapter7Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData2_7_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"InvationChapter8Lan.png";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"InvationChapter8Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (bookData *)createBook4{
    bookData *data = [[bookData alloc] init];
    data.bookName = @"能化周刊三月刊";
    data.covorImage = @"Book01.png";
    
    NSMutableArray *arrChapterData = [[NSMutableArray alloc] init];
#pragma mark chapter1
    chapterData *chapter = [[chapterData alloc] init];
    chapter.chapterName =  @"能化周刊";
    NSMutableArray *arrTextData = [[NSMutableArray alloc] init];
    textData *text = [self createTextData3_0_0];
    [arrTextData addObject:text];
    [text release];
...
#pragma mark chapter2
    chapterData *chapter1 = [[chapterData alloc] init];
    chapter1.chapterName =  @"触控说明";
    NSMutableArray *arrTextData1 = [[NSMutableArray alloc] init];
    textData *text1 = [self createTextData3_1_0];
    [arrTextData1 addObject:text1];
    [text1 release];
...
#pragma mark chapter3
    chapterData *chapter2 = [[chapterData alloc] init];
    chapter2.chapterName = @"能化周刊目录";
    NSMutableArray *arrTextData2 = [[NSMutableArray alloc] init];
    textData *text2 = [self createTextData3_2_0];
    [arrTextData2 addObject:text2];
    [text2 release];
...
#pragma mark chapter4
    chapterData *chapter3 = [[chapterData alloc] init];
    chapter3.chapterName = @"本周行情综述";
    NSMutableArray *arrTextData3 = [[NSMutableArray alloc] init];
    
    textData *text3 = [self createTextData3_3_0];
    [arrTextData3 addObject:text3];
    [text3 release];
    
    textData *text3_1 = [self createTextData3_3_1];
    [arrTextData3 addObject:text3_1];
    [text3_1 release];
...
#pragma mark chapter5
    chapterData *chapter4 = [[chapterData alloc] init];
    chapter4.chapterName = @"基本面分析";
    NSMutableArray *arrTextData4 = [[NSMutableArray alloc] init];
    
    textData *text4 = [self createTextData3_4_0];
    [arrTextData4 addObject:text4];
    [text4 release];
    
    textData *text4_1 = [self createTextData3_4_1];
    [arrTextData4 addObject:text4_1];
    [text4_1 release];
    
    textData *text4_2 = [self createTextData3_4_2];
    [arrTextData4 addObject:text4_2];
    [text4_2 release];
    
    textData *text4_3 = [self createTextData3_4_3];
    [arrTextData4 addObject:text4_3];
    [text4_3 release];
...
#pragma mark chapter6
    chapterData *chapter5 = [[chapterData alloc] init];
    chapter5.chapterName = @"后市展望";
    NSMutableArray *arrTextData5 = [[NSMutableArray alloc] init];
    
    textData *text5 = [self createTextData3_5_0];
    [arrTextData5 addObject:text5];
    [text5 release];
    
    textData *text5_1 = [self createTextData3_5_1];
    [arrTextData5 addObject:text5_1];
    [text5_1 release];
...
#pragma mark chapter7
    ...
    textData *text6 = [self createTextData3_6_0];
    [arrTextData6 addObject:text6];
    [text6 release];
...
#pragma mark chapter8
    ...
    textData *text7 = [self createTextData3_7_0];
    [arrTextData7 addObject:text7];
    [text7 release];
...
+ (textData *)createTextData3_0_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter1.jpg";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter1Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData3_1_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter2.jpg";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter2Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData3_2_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter3.jpg";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter3Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData3_3_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter4.jpg";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter4Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData3_3_1{
    ...
    colors *col_1 = [[colors alloc] init];
    col_1.color = @"blueColor";
    [arrColors addObject:col_1];
    [col_1 release];
    
    colors *col_2 = [[colors alloc] init];
    col_2.color = @"yellowColor";
    [arrColors addObject:col_2];
    [col_2 release];
    ...
    ranges *ran_1 = [[ranges alloc] init];
    ran_1.range = NSStringFromRange(NSMakeRange(136,3));
    [arrRanges addObject:ran_1];
    [ran_1 release];
    
    ranges *ran_2 = [[ranges alloc] init];
    ran_2.range = NSStringFromRange(NSMakeRange(255,5));
    [arrRanges addObject:ran_2];
    [ran_2 release];
    ...
    key *aKey = [[key alloc] init];
    aKey.tag = @"1";
    aKey.range = NSStringFromRange(NSMakeRange(136, 3));
    [arrKey addObject:aKey];
    [aKey release];
    
    key *aKey_1 = [[key alloc] init];
    aKey_1.tag = @"2";
    aKey_1.range = NSStringFromRange(NSMakeRange(255, 5));
    [arrKey addObject:aKey_1];
    [aKey_1 release];
    ...
    NSMutableArray *arrPicNames = [[NSMutableArray alloc] init];
    picNames *picName = [[picNames alloc] init];
    picName.picName = @"longTextPic.png";
    [arrPicNames addObject:picName];
    [picName release];
    text.picNames = arrPicNames;
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"middleTextPic.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData3_4_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter5.jpg";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter5Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData3_4_1{
    ...
    ranges *ran_1 = [[ranges alloc] init];
    ran_1.range = NSStringFromRange(NSMakeRange(11,133));
    [arrRanges addObject:ran_1];
    [ran_1 release];
    ...
    rangesPor *ranPor_1 = [[rangesPor alloc] init];
    ranPor_1.rangePor = NSStringFromRange(NSMakeRange(11,150));
    [arrRangesPor addObject:ranPor_1];
    [ranPor_1 release];
    ...
    bgNamesPor *bgNamePor = [[bgNamesPor alloc] init];
    bgNamePor.bgNamePor = @"pic3Por.png";
    [arrBgNamesPor addObject:bgNamePor];
    [bgNamePor release];
    text.bgNamesPor = arrBgNamesPor;
...
+ (textData *)createTextData3_4_3{
    textData *text = [[textData alloc] init];
    
    text.title = @"需求和库存方面的情况";
    text.text = @"第二部分 基本面分析\n3、	需求和库存方面的情况：\n美国能源信息署数据显示，截止2013年1月11日的四周，美国成品油需求总量平均每天1836.5万桶，比去年同期高1.7%；汽油需求四周日均量836.4万桶，比去年同期低0.6%；馏份油需求四周日均数337.5万桶，比去年同期低5.2%；煤油型航空燃料需求四周日均数比去年同期高1.1%。尽管美国原油库存下降，但是仍然远高于历史同期平均水平，且比去年同期高8.8%。美国原油产量迅速增长，今年开始突破每日700万桶，截止1月11日，美国原油日产量704.1万桶，比前周增长3.9万桶，比去年同期增长131.5万桶，增幅23%。然而这些增产的原油集中在美国中西部地区，且为页岩油，导致备受关注的西德克萨斯轻质原油期货交货地库欣地区原油库存继续创历史最高纪录，且十分接近最高有效库存容量。据美国能源信息署统计，由于成品油库存增长，过去的一周，美国石油库存总量增加了344万桶万桶，其中汽油库存增加191万桶万桶，馏分油库存增加169万桶。";
    text.titleFontSize = @"38";
    text.titleLength = @"10";
    text.titleFontName = @"Helvetica";
    ...
    NSMutableArray *arrPicNames = [[NSMutableArray alloc] init];
    picNames *picName = [[picNames alloc] init];
    picName.picName = @"longTextPicHeight.png";
    [arrPicNames addObject:picName];
    [picName release];
    text.picNames = arrPicNames;
...
+ (textData *)createTextData3_5_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter6.jpg";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter6Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData3_5_1{
    textData *text = [[textData alloc] init];
    
    text.title = @"第三部分 后市展望";
    ...
    //landscape
    //图片位置
    text.rects = [NewBannerText setTextRect];
    text.picRects = [NewBannerText setImageRect];
    //portrait
    text.rectsPor = [NewBannerTextPor setTextRect];
    text.picRectsPor = [NewBannerTextPor setImageRect];
    
    //图片名称
    NSMutableArray *arrPicNames = [[NSMutableArray alloc] init];
    picNames *picName = [[picNames alloc] init];
    picName.picName = @"movpic.png";
    [arrPicNames addObject:picName];
    [picName release];
    text.picNames = arrPicNames;
    ...
    NSMutableArray *arrPicNamesPor = [[NSMutableArray alloc] init];
    picNamesPor *picNamePor = [[picNamesPor alloc] init];
    picNamePor.picNamePor = @"movpic.png";
    [arrPicNamesPor addObject:picNamePor];
    text.picNamesPor = arrPicNamesPor;
...
+ (textData *)createTextData3_6_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter7.jpg";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter7Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
...
+ (textData *)createTextData3_7_0{
    textData *text = [[textData alloc] init];
    text.title = @"章节首页";
    picNames *pName = [[picNames alloc] init];
    pName.picName = @"Chapter8.jpg";
    picNamesPor *pNamePor = [[picNamesPor alloc] init];
    pNamePor.picNamePor = @"Chapter8Por.png";
    picRects *picRect = [[picRects alloc] init];
    picRect.picRect = NSStringFromCGRect(CGRectMake(0, 64, 1024, 704));
    picRectsPor *picRectPor = [[picRectsPor alloc] init];
    picRectPor.picRectPor = NSStringFromCGRect(CGRectMake(0, 64, 768, 960));
